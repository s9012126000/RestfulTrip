...
def get_date_limitation(day):
    ...
    checkin_limit = (datetime.datetime.now() + datetime.timedelta(days=day)).date().isoformat()
    checkout = (datetime.datetime.now() + datetime.timedelta(days=1)).date().isoformat()
    checkout_limit = (datetime.datetime.now() + datetime.timedelta(days=day+1)).date().isoformat()
